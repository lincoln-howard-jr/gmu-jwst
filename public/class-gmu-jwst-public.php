...
class Gmu_Jwst_Public {
	...
	public function page_display () {
		require_once 'partials/gmu-jwst-public-display.php';
	}

	public function add_jwst_page () {
		add_shortcode ('gmu-jwst', array($this, 'page_display'));
	}
